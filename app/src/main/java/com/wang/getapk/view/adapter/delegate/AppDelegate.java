...
public class AppDelegate extends AdapterDelegate<AppDelegate.AppViewHolder> {
    ...
    public AppDelegate(OnRecyclerClickListener listener) {
        mListener = listener;
    }
    ...
    public void onBindViewHolder(ItemArray itemArray, AppViewHolder vh, int position) {
        ...
        vh.mPackageTV.setText(app.packageName);
        if (app.isDebug) {
    ...
    static class AppViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppViewHolder(View itemView, final OnRecyclerClickListener listener) {
            super(itemView);
            ButterKnife.bind(this, itemView);
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onClick(getItemViewType(), getAdapterPosition(), mApp);
                }
            });
        }
